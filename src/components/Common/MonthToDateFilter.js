...
class MonthToDateFilter extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
                  ...
                  <div className="form-horizontal">
                    <Form noValidate validated={values.validated}>
                      <Form.Row>
                            ...
                            <Form.Group as={Row}>
                              ...
                              <Col md="9">
                                <Form.Control
                                  ...
                                  type="text"
                                  as="select"
                                  value={values.mtdArrearsBranch}
                                  id="mtdArrearsBranch"
                                  name="mtdArrearsBranch"
                                  onChange={this.props.handleChange}
                                >
                                  <option value="" />
                                  {values.companyBranches
                                    .map((branch, key) => (
                                      <option key={key} value={branch.hostBranchId}>
                                        {branch.name}
                                      </option>
                                    ))}
                                </Form.Control>
                        ...
                        ) : (parseInt(sessionStorage.getItem('userType'), 10) === 3 && values.mtdArrearsBranch !== '' ? (
                          <Col xs={12} md={4}>
                            <Form.Group as={Row}>
                              <Form.Label column md="3">
                                RO
...
export default MonthToDateFilter;
