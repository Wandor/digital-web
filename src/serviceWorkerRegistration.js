        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              document
                .getElementById('update-installer')
...
export function getNotifications() {
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.ready.then((registration) => {
      registration.getNotifications().then((pushNotifications) => {
        ...
        pushNotifications.forEach((pushNotification) => {
          ...
          if (
            ...
            const data = {
              ...
              userId:
                pushNotification.data !== null
                  ? pushNotification.data.userId
                  : '',
              userType:
                pushNotification.data !== null
                  ? pushNotification.data.userType
                  : '',
              branchId:
                pushNotification.data !== null
                  ? pushNotification.data.branchId
                  : '',
              companyId:
                pushNotification.data !== null
                  ? pushNotification.data.companyId
                  : '',
